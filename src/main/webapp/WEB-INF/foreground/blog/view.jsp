...
<script type="text/javascript">
	...
	function submitData(){
		...
		if(content==null || content==''){
			...
			$.post("/comment/save",{'content':content,'blog.id':'${blog.id}'},function(result){
				if(result.success){
...
<div class="data_list">
	<div class="data_list_title">
		<img src="/images/blog_show_icon.png"/>
		博客信息
	</div>
	<div>
	   ...
	   <div style="padding-left: 330px;padding-bottom: 20px;padding-top: 10px">
		...
		<div class="blog_info">
			发布时间：『 ${blog.releaseDate}』&nbsp;&nbsp;博客类别：${blog.blogType.typeName}&nbsp;&nbsp;阅读(${blog.clickHit}) 评论(${blog.replyHit})
		</div>
			...
			<c:choose>
				...
				<c:otherwise>
					<c:forEach var="keyWord" items="${keyWords }">
						&nbsp;&nbsp;<a href="/q?q=${keyWord}" target="_blank">${keyWord }</a>&nbsp;&nbsp;
					</c:forEach>
				</c:otherwise>
			</c:choose>
		</div>
...
<div class="data_list" >
	<div class="data_list_title">
		<img src="/images/publish_comment_icon.png"/>
		发表评论
	</div>
	<div class="publish_comment">
			<div>
				<textarea style="width: 100%" rows="3" id="content" name="content" placeholder="来说几句吧..."></textarea>
			</div>
